...
void TextPrinter::print(const type_info::Value& v) {
    ...
    switch ( v.type().tag ) {
        ...
        case TypeInfo::SignedInteger_int8_t: out() << static_cast<int16_t>(type.signed_integer_int8->get(v)); break;
        case TypeInfo::SignedInteger_int16_t: out() << type.signed_integer_int16->get(v); break;
        case TypeInfo::SignedInteger_int32_t: out() << type.signed_integer_int32->get(v); break;
        case TypeInfo::SignedInteger_int64_t: out() << type.signed_integer_int64->get(v); break;
        ...
        case TypeInfo::UnsignedInteger_uint8_t:
            out() << static_cast<int16_t>(type.unsigned_integer_uint8->get(v));
            break;
        case TypeInfo::UnsignedInteger_uint16_t: out() << type.unsigned_integer_uint16->get(v); break;
        case TypeInfo::UnsignedInteger_uint32_t: out() << type.unsigned_integer_uint32->get(v); break;
        case TypeInfo::UnsignedInteger_uint64_t: out() << type.unsigned_integer_uint64->get(v); break;
