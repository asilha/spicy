...
nlohmann::json JSONPrinter::convert(const hilti::rt::type_info::Value& v) {
    ...
    switch ( v.type().tag ) {
        ...
        case TypeInfo::SignedInteger_int8_t: return type.signed_integer_int8->get(v);
        case TypeInfo::SignedInteger_int16_t: return type.signed_integer_int16->get(v);
        case TypeInfo::SignedInteger_int32_t: return type.signed_integer_int32->get(v);
        case TypeInfo::SignedInteger_int64_t: return type.signed_integer_int64->get(v);
        ...
        case TypeInfo::UnsignedInteger_uint8_t: return type.unsigned_integer_uint8->get(v);
        case TypeInfo::UnsignedInteger_uint16_t: return type.unsigned_integer_uint16->get(v);
        case TypeInfo::UnsignedInteger_uint32_t: return type.unsigned_integer_uint32->get(v);
        case TypeInfo::UnsignedInteger_uint64_t: return type.unsigned_integer_uint64->get(v);
